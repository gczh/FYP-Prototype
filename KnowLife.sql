...
--
-- Host: localhost
-- Generation Time: Mar 10, 2013 at 06:06 PM
...
CREATE TABLE IF NOT EXISTS `Events` (
  ...
  `map_values` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Groups` (
  ...
  `group_image` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `Groups` (`group_id`, `group_name`, `description`, `created_date`, `group_image`) VALUES
(1, 'Fellow Geeks', 'Come forth my geeks and thine shall rule with binary.', '2013-02-01 19:30:00', ''),
(2, 'Sporty Sports', 'Sporty peeps are sortied in here!', '2010-08-28 14:30:00', ''),
(3, 'Technology', 'Anything technology goes here! Have fun!', '2012-08-29 00:00:00', 'img/something.jpg');
...
CREATE TABLE IF NOT EXISTS `Users` (
  ...
  `nric` varchar(9) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `Users` (`user_id`, `created_date`, `username`, `password`, `nric`, `age`, `gender`, `email`, `user_picture`) VALUES
(1, '2013-03-10 05:46:25', 'Gabriel', 'gabriel', 's9494123c', 18, 'm', 'gabriel@gabriel.com', 'resources/images/img1.jpg'),
(2, '2013-03-10 05:48:45', 'Eugene', 'eugene', 's91920383', 17, 'm', 'eugene@eugene.com', 'resources/images/img2.jpg'),
(3, '2013-03-10 05:48:45', 'Kimly', 'kimly', 's18295382', 20, 'f', 'kimly@kimly.com', 'resources/images/img3.jpg'),
(4, '2013-03-10 05:48:45', 'Carden', 'carden', 's18293859', 18, 'f', 'carden@carden.com', 'resources/images/img4.jpg'),
(5, '2013-03-10 05:48:45', 'Pershian', 'pershian', 's91829302', 22, 'f', 'pershian@pershian.com', 'resources/images/img5.jpg'),
(6, '2013-03-10 07:19:56', 'WeiSheng', 'weisheng', 's91723998', 19, 'm', 'weisheng@weisheng.com', 'resources/images/img6.jpg'),
(7, '2013-03-10 11:15:49', 'Kardashian', 'kardashian', 's94182938', 19, 'f', 'kardashian@kardashian.com', 'resources/images/img7.jpg'),
(8, '2013-03-10 12:01:44', 'YingShong', 'YingShong', 's94182938', 19, 'm', 'YS_2009@hotmail.com', 'resources/images/img8.jpg'),
(9, '2013-03-10 12:01:44', 'Timothy', 'Timothy', 's94184506', 17, 'm', 'timmy@gmail.com', 'resources/images/img9.jpg'),
(10, '2013-03-10 12:01:44', 'JunYao', 'JunYao', 's95872958', 22, 'm', 'Jyjy@gmail.com', 'resources/images/img10.jpg'),
(11, '2013-03-10 12:01:44', 'WaiCheng', 'WaiCheng', 's93968492', 18, 'm', 'Jerome@gmail.com', 'resources/images/img11.jpg'),
(12, '2013-03-10 12:01:44', 'Nicholas', 'Nicholas', 's19485673', 20, 'm', 'Nicky@gmail.com', 'resources/images/img12.jpg'),
(13, '2013-03-10 12:01:44', 'WeiCheng', 'WeiCheng', 's76937456', 19, 'm', 'WC21@gmail.com', 'resources/images/img13.jpg'),
(14, '2013-03-10 12:01:44', 'Candy', 'Candy', 's95048396', 20, 'f', 'Sweet99@gmail.com', 'resources/images/img14.jpg'),
(15, '2013-03-10 12:01:44', 'Gwenda', 'Gwenda', 's95863453', 19, 'f', 'Gwen77@gmail.com', 'resources/images/img15.jpg'),
(16, '2013-03-10 12:01:44', 'ShiHui', 'ShiHui', 's86753275', 21, 'f', 'SH86@gmail.com', 'resources/images/img16.jpg'),
(17, '2013-03-10 13:07:59', 'Zeno Hao', 'zenohao', 's9172937c', 22, 'm', 'zenohao@zenohao.com', 'resources/images/life.jpg');
...
CREATE TABLE IF NOT EXISTS `user_event` (
  `user_event_id` int(255) NOT NULL AUTO_INCREMENT,
  `event_id` int(255) NOT NULL,
  `user_id` int(255) NOT NULL,
  `join_date` datetime NOT NULL COMMENT 'this is the datetime of when the user joined the event. useful in determining whether a user activity is recent etc...',
...
--
-- Table structure for table `user_favorite_event`
--

CREATE TABLE IF NOT EXISTS `user_favorite_event` (
  `user_favorite_event_id` int(255) NOT NULL AUTO_INCREMENT,
  `user_id` int(255) NOT NULL,
  `event_id` int(255) NOT NULL,
  PRIMARY KEY (`user_favorite_event_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- Table structure for table `user_favorite_user`
--

CREATE TABLE IF NOT EXISTS `user_favorite_user` (
  `user_favorite_user_id` int(255) NOT NULL AUTO_INCREMENT,
  `user_id` int(255) NOT NULL,
  `favorite_user_id` int(255) NOT NULL,
  PRIMARY KEY (`user_favorite_user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `user_friendship` (
  `user_friendship_id` int(255) NOT NULL AUTO_INCREMENT,
  `curr_user_id` int(255) NOT NULL,
...
INSERT INTO `user_friendship` (`user_friendship_id`, `curr_user_id`, `target_user_id`) VALUES
(1, 1, 2),
(2, 2, 1),
(3, 1, 3),
(4, 3, 1),
...
CREATE TABLE IF NOT EXISTS `user_group` (
  `user_group_id` int(255) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `user_group` (`user_group_id`, `group_id`, `user_id`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
